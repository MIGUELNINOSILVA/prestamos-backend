...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/miguel/Documentos/multitenant/prestamos/prisma/generated/client/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/miguel/Documentos/multitenant/prestamos/prisma/client.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "CLIENT_DB_URL",
        "value": null
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/client/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"CLIENT_DB_URL\")\n}\n\nmodel Company {\n  id   Int    @id @default(autoincrement())\n  name String\n\n  @@map(\"company\")\n}\n",
  "inlineSchemaHash": "ed0989d2b41ff7eda25b41f659a371a15d810ff216b65a040da7a6bfb8b83350",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/generated/client/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/client/client/schema.prisma")
